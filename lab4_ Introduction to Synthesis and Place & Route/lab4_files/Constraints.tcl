...
#---------------------------------------------------------
 set target_library NangateOpenCellLibrary_slow_ccs.db
 set link_library   [concat  $target_library $synthetic_library]

#---------------------------------------------------------
# Specify a CLK_PER ns clock period with 50% duty cycle     
# and a skew of 50ps                                 
#---------------------------------------------------------
 set CLK_PER  20.0
 set CLK_SKEW 0.05
 create_clock -name $clkname -period $CLK_PER -waveform "0 [expr $CLK_PER / 2.0]" $clkname
